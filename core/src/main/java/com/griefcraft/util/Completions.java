...
public class Completions {
    ...
    private static final List<String> FLAGS = Arrays.asList("redstone", "magnet", "exemption", "auto-close", "allow-explosions", "hopper", "hopper-in", "hopper-out", "lectern-view-only", "lectern-auto-rewind");
    ...
    private static final List<String> modifications = Arrays.asList("-", "@");
